  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <ConnectedAccountsDialog clientId={clientId} accounts={accounts} />
      </div>
      ...
      {!hasAccounts ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Connect your social media accounts to start syncing content.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className='text-sm text-muted-foreground'>
              Click the "Connected Accounts" button above to connect Instagram,
              Facebook, and more.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className='text-sm text-muted-foreground'>
              Content feed with filtering coming soon. Use "Connected Accounts"
              to sync your latest posts.
            </p>
          </CardContent>
        </Card>
      )}
