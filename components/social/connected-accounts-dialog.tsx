    ...
    try {
      if (platformId === 'meta') {
        ...
        if (igSuccess && fbSuccess) {
          ...
          const synced = (igResult?.synced || 0) + (fbResult?.synced || 0);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className='sm:max-w-[600px]'>
        <DialogHeader>
          ...
          <DialogDescription>
            Connect your social media accounts to sync content for this client.
          </DialogDescription>
        </DialogHeader>
                  ...
                  <div className='flex gap-2'>
                    {isConnected && !platform.disabled && (
                      <Button
                        ...
                        disabled={syncing === platform.id || isPending}
                        className='flex-1'
                      >
                        <RefreshCw
